## OS Requirements
- Arch Linux or any Arch Linux based distro (should use `systemd` as init system)
- SDDM display manager
- KDE Plasma Desktop (__Other desktops are also supported__, but KDE Plasma is recommended for the best experience.)

## Hardware Requirements

!!! warning
	The Gamescope session may not work on all hardware, as it was primarily developed for the Steam Deck.

!!! info
	You can install it on your system and try it out. If you encounter any issues, you can remove the script using the Uninstall option in GUI Helper.
