...
- **Login Manager Configuration**: Automatically configures SDDM for autologin.
...
!!! info
	Check [Installation](installation.md) page for more information.
...
```
!!! info
	You can also change the default Desktop Mode session via the GUI Helper.
...
**Unfortunately, system updates are not possible through Steam settings.** For more information, check [Updating System](updatingsystem.md) page.

## Decky Plugin Loader
The [Decky Loader](https://decky.xyz/) is an **unofficial** community-driven tool that allows you to install and manage plugins for your Steam interface. While not essential for system functionality, it provides additional customization options for SteamOS. (https://decky.xyz/)
...
!!! info
	For more information, check: [https://decky.xyz/](https://decky.xyz/)

!!! info
	You can also install/uninstall/reinstall the Decky Loader via the GUI Helper.
